 ...
 *
 * <p>
 * Principal Component Analysis (PCA) is typically used to develop a linear model for a basic.set of data
 * (e.g. face images) which can then be used to test for membership.  PCA works by converting the
 * basic.set of data to a new basis that is a subspace of the original basic.set.  The subspace is selected
 ...
 * computing the variance of each sample basic.set. The variance is computed by squaring the residual, which can
...
public class PrincipalComponentAnalysis {
    ...
    public void computeBasis( int numComponents ) {
        ...
        // Compute SVD and save basic.time by not computing U
     ...
     * it can be considered a member.  The threshold's value depends on the data basic.set.
     * </p>
     * <p>
     ...
     * for membership in the training sample basic.set.  High values correspond to a better fit.
     *
