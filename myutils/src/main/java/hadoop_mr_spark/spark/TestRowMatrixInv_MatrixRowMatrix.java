...
/**
 * inverse of matrix in hadoop_mr_spark.spark
 *
 * @author liuqiang
...
public class TestRowMatrixInv_MatrixRowMatrix {
    ...
    /*
    import org.apache.hadoop_mr_spark.spark.mllib.linalg.{Vectors,Vector,Matrix,SingularValueDecomposition,DenseMatrix,DenseVector}
import org.apache.hadoop_mr_spark.spark.mllib.linalg.distributed.RowMatrix
...
def computeInverse(X: RowMatrix): DenseMatrix = {
  ...
  val invS = DenseMatrix.diag(new DenseVector(svd.s.toArray.map(x => math0.math.pow(x,-1))))
...
//        });
        ...
        System.out.println("basic.list size: "+collect.size());
